...
return [
   ...
   // Custom Messages
   'max_array_size'        => 'The {field} array may only contain up to {param} element(s).',
   'min_array_size'        => 'The {field} array must contain at least {param} element(s).',
   'is_boolean'            => 'The {field} field must be a boolean.',
   'valid_array'           => 'The {field} field must be an array.',
